...
export const DEFAULT_STATION_TRANSIT_TIME = 150; // 2.5 minutes in seconds
...
export const AVG_METRO_SPEED_KMH = 35; // Average metro speed in km/h
export const AVG_METRO_SPEED_MS = (AVG_METRO_SPEED_KMH * 1000) / 3600; // Converted to m/s
export const MIN_STATION_TIME = 90; // Minimum transit time between stations in seconds
